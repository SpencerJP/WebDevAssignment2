...
namespace ASPNETAssignment.Controllers
{
    public class StoreInventoriesController : Controller
    {
        ...
        public StoreInventoriesController(ASPNetAssignmentContext context)
        {
            _context = context;
        }
        ...
        {
            var aSPNetAssignmentContext = _context.StoreInventory.Include(s => s.Product).Include(s => s.Store);
